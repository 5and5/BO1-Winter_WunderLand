...
include_weapons()
{
	...
	include_weapon( "colt45_mp", false );
	include_weapon( "cz75" );
	include_weapon( "python" );

	// Bolt Action
	//include_weapon( "zombie_kar98k" );
	include_weapon( "zombie_kar98k_upgraded", false );
	//include_weapon( "remington700_mp" );
	...
	include_weapon( "m14", false );
	include_weapon( "m16", false );
	include_weapon( "fal" );
	...
	include_weapon( "mpl", false );
	include_weapon( "pm63", false );
	include_weapon( "mp5", false );
	include_weapon( "ak74u", false );
	include_weapon( "aug" );
	include_weapon( "commando" );
	include_weapon( "famas" );
	include_weapon( "g11" );
	include_weapon( "galil" );
	include_weapon( "spectre" );

	// Scoped
	include_weapon( "ptrs41_zombie" );
	include_weapon( "ptrs41_zombie_upgraded", false );
	// include_weapon( "dragunov" );
	include_weapon( "l96a1" );
	...
	include_weapon( "olympia", false );
	include_weapon( "stakeout", false );
	include_weapon( "hs10" );
	include_weapon( "spas" );
	...
	include_weapon( "china_lake" );
	include_weapon( "m72_law" );

	// Special
	include_weapon ("ray_gun", true );
	// include_weapon( "ray_gun", true, ::factory_ray_gun_weighting_func );
	include_weapon( "ray_gun_upgraded", false );
	include_weapon( "tesla_gun", true, maps\_zombiemode_weapons::default_tesla_weighting_func );
	...
	//include_weapon( "type99lmg_bayonet_mp", true );
	// include_weapon( "mortar_round" );
	include_weapon( "thundergun", true, maps\_zombiemode_weapons::default_thundergun_weighting_func );
...
include_powerups()
{
	...
	// include_powerup( "carpenter" );	Carpenters removed  --Just_Crusader / JC :D I love you JC. --Demzyy // Demonz :D
}
...
{	
	while(1)
	{
		...
		//player is standing electricity
		if(isplayer(ent) )
		{
