...
treasure_chest_give_weapon( weapon_string )
{
	...
	if( primaryWeapons.size >= weapon_limit )
	{
		...
		{	
			...
			{	
				...
				if( current_weapon == "zombie_nesting_dolls" )
				{
					level.player_drops_dolls = true;
				}

				if( current_weapon == "ray_gun_zm" )
				{
					level.player_drops_ray_gun = true;
				}
	...
	if( weapon_string == "zombie_nesting_dolls" )
	{
